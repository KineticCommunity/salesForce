...
class SalesforceOpportunityRetrieveV1
  ...
  def execute()
    ...
    <<-RESULTS
    <results>
        <result name="Opportunity Name">#{result['Name']}</result>
        <result name="Close Date">#{result['CloseDate']}</result>
        <result name="Stage">#{result['StageName']}</result>
        <result name="Private">#{result['IsPrivate']}</result>
        <result name="Type">#{result['Type']}</result>
        <result name="Lead Source">#{result['LeadSource']}</result>
        <result name="Amount">#{result['Amount']}</result>
        <result name="Next Step">#{result['NextStep']}</result>
        <result name="Probability">#{result['Probability']}</result>
    </results>
    RESULTS
  end
