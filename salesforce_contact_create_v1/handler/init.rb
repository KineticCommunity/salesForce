...
class SalesforceContactCreateV1
  ...
  def execute()
    ...
    uri = URI.parse("https://#{@instance}.salesforce.com/services/data/v20.0/sobjects/Contact/")
    ...
    <<-RESULTS
    <results>
      <result name="Contact Id">#{result["id"]}</result>
    </results>
    RESULTS
  end
