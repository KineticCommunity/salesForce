...
class SalesforceAccountCreateV1
  ...
  def execute()
    ...
    uri = URI.parse("https://#{@instance}.salesforce.com/services/data/v20.0/sobjects/Account/")
    ...
    <<-RESULTS
    <results>
      <result name="Account Id">#{result['id']}</result>
    </results>
    RESULTS
  end
