...
class SalesforceOpportunityCreateV1
  ...
  def execute()
    ...
    uri = URI.parse("https://#{@instance}.salesforce.com/services/data/v20.0/sobjects/Opportunity/")
    ...
    <<-RESULTS
    <results>
      <result name="Opportunity Id">#{result["id"]}</result>
    </results>
    RESULTS
  end
