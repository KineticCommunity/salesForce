...
class SalesforceContactUpdateV1
  ...
  # Update a Salesforce Contact record with the given parameters.
  # This method sets the following instance variables:
  ...
  def execute()
    ...
    # to construct the URL.  The request is also sent as POST and the JSON String
