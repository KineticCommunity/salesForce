...
if not defined?(Hashie)
  ...
  handler_path = File.expand_path(File.dirname(__FILE__))
  # Calculate the location of our library and add it to the Ruby load path
  library_path = File.join(handler_path, "vendor/hashie-3.3.4/lib")
  $:.unshift library_path
  # Require the library
  require "hashie"
end
...
if not defined?(MultipartPost)
  ...
  handler_path = File.expand_path(File.dirname(__FILE__))
  # Calculate the location of our library and add it to the Ruby load path
  library_path = File.join(handler_path, "vendor/multipart-post-2.0.0/lib")
  $:.unshift library_path
  # Require the library
...
if not defined?(Faraday)
  ...
  handler_path = File.expand_path(File.dirname(__FILE__))
  # Calculate the location of our library and add it to the Ruby load path
  library_path = File.join(handler_path, "vendor/faraday-0.9.2/lib")
  $:.unshift library_path
  # Require the library
  require "faraday"
end
...
if not defined?(FaradayMiddleware)
  ...
  handler_path = File.expand_path(File.dirname(__FILE__))
  # Calculate the location of our library and add it to the Ruby load path
  library_path = File.join(handler_path, "vendor/faraday_middleware-0.10.0/lib")
  $:.unshift library_path
  # Require the library
  require "faraday_middleware"
end

if not defined?(Restforce)
  # Calculate the location of this file
  handler_path = File.expand_path(File.dirname(__FILE__))
  # Calculate the location of our library and add it to the Ruby load path
  library_path = File.join(handler_path, "vendor/restforce-2.3.0/lib")
  $:.unshift library_path
  # Require the library
  require "restforce"
end
